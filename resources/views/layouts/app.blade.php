                  ...
                  {{-- investor --}}
                    ...
                    <form id="form-investor" method="POST" action="{{ route('investor.store') }}" style="width: max-content;">
                      ...
                      <div class="form-group has-feedback {{ $errors->has('no_telp') ? 'has-error' : '' }}">
                        <label for="email" class="col-lg-8 col-form-label text-md-right">{{ __('No telphone') }}</label>
                    ...
                    <form id="form-peternak" method="POST" action="{{ route('peternak.store') }}" style="width: max-content;">
                      @csrf
                      ...
                      <div class="form-group has-feedback {{ $errors->has('provinsi') ? 'has-error' : '' }}">
                        ...
                        <input name="provinsi" value="{{ old('provinsi') }}" type="text" class="form-control" placeholder="provinsi">
                        @if($errors->has('provinsi')) <span class="help-block">{{ $errors->first('provinsi') }}</span> @endif
                      </div>
                      ...
                      <div class="form-group has-feedback {{ $errors->has('kabupaten') ? 'has-error' : '' }}">
                        ...
                        <input name="kabupaten" value="{{ old('kabupaten') }}" type="text" class="form-control" placeholder="Kabupaten">
                        @if($errors->has('kabupaten')) <span class="help-block">{{ $errors->first('kabupaten') }}</span> @endif
                      </div>
                      ...
                      <div class="form-group has-feedback {{ $errors->has('kecamatan') ? 'has-error' : '' }}">
                        ...
                        <input name="kecamatan" value="{{ old('kecamatan') }}" type="text" class="form-control" placeholder="Kecamatan">
                        @if($errors->has('kecamatan')) <span class="help-block">{{ $errors->first('kecamatan') }}</span> @endif
                      </div>
                      ...
                      <div class="form-group has-feedback {{ $errors->has('kelurahan') ? 'has-error' : '' }}">
                        ...
                        <input name="kelurahan" value="{{ old('kelurahan') }}" type="text" class="form-control" placeholder="Kelurahan">
                        @if($errors->has('kelurahan')) <span class="help-block">{{ $errors->first('kelurahan') }}</span> @endif
                      </div>
                      ...
                      <div class="form-group has-feedback {{ $errors->has('foto_kandang') ? 'has-error' : '' }}">
                        ...
                        <input name="foto_kandang" value="{{ old('foto_kandang') }}" type="file" class="form-control" placeholder="Foto Kandang">
                        @if($errors->has('foto_kandang')) <span class="help-block">{{ $errors->first('foto_kandang') }}</span> @endif
                      </div>
                      ...
                      <div class="form-group has-feedback {{ $errors->has('foto_ktp') ? 'has-error' : '' }}">
                        ...
                        <input name="foto_ktp" value="{{ old('foto_ktp') }}" type="file" class="form-control" placeholder="Foto KTP">
                      ...
                      <div class="form-group has-feedback {{ $errors->has('foto_profil') ? 'has-error' : '' }}">
                        ...
                        <input name="foto_profil" value="{{ old('jenis_kelamin') }}" type="file" class="form-control" placeholder="Foto Profil">
                      ...
                      <div class="form-group has-feedback {{ $errors->has('no_ktp') ? 'has-error' : '' }}">
                        ...
                        <input name="no_ktp" value="{{ old('no_ktp') }}" type="text" class="form-control" placeholder="No KTP">
                      ...
                      <div class="form-group has-feedback {{ $errors->has('tgl_lahir') ? 'has-error' : '' }}">
                        ...
                        <input name="tgl_lahir" value="{{ old('tgl_lahir') }}" type="date" class="form-control" placeholder="Tanggal Lahir">
