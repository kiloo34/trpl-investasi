						...
						<li class="dropdown">
							...
							<ul id="login-dp" class="dropdown-menu">
								<li>
									...
									<button id="button-investor" type="button" class="btn btn-primary btn-block">Investor</button> {{-- investor --}}
									...
									<form id="form-investor" method="POST" action="{{ route('investor.store') }}" style="width: max-content;">
										...
										<div class="form-group has-feedback {{ $errors->has('nama') ? 'has-error' : '' }}">
											...
											<input name="nama" value="{{ old('nama') }}" type="text" class="form-control" placeholder="Nama" required> @if($errors->has('nama'))
										...
										<div class="form-group has-feedback {{ $errors->has('email') ? 'has-error' : '' }}">
											...
											<input name="email" type="email" class="form-control{{ $errors->has('email') ? ' is-invalid' : '' }}" name="email" value="{{ old('email') }}"
										...
										<div class="form-group has-feedback {{ $errors->has('password') ? 'has-error' : '' }}">
											<label for="password" class="col-md-8 col-form-label text-md-right">{{ __('Password') }}</label>
											<input name="password" value="{{ old('password') }}" type="password" class="form-control" placeholder="Password" required>											@if ($errors->has('password'))
											<span class="invalid-feedback" role="alert">
                                            <strong>{{ $errors->first('password') }}</strong>
                                        </span> @endif
										</div>
										...
										<div class="form-group{{ $errors->has('no_telp') ? ' has-error' : '' }}">
											...
											<input id="no_telp" type="number" class="form-control" name="no_telp" value="{{ old('no_telp') }}" required autofocus>											@if ($errors->has('no_telp'))
											<span class="help-block">
									...
									<form id="form-peternak" method="POST" action="{{ route('peternak.store') }}" style="width: max-content;" enctype="multipart/form-data">
										...
										<div class="form-group has-feedback {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
											<input name="password_confirmation" value="{{ old('password_confirmation') }}" type="password" class="form-control" placeholder="Ketik ulang password"required> 
											 @if ($errors->has('password_confirmation'))<span class="invalid-feedback" role="alert"><strong>{{ $errors->first('password_confirmation') }}</strong></span> @endif
										</div>
										...
										<div class="form-group has-feedback {{ $errors->has('alamat') ? 'has-error' : '' }}">
											...
											@if ($errors->has('alamat'))<span class="invalid-feedback" role="alert"><strong>{{ $errors->first('alamat') }}</strong></span> @endif
										</div>
										...
										<div class="form-group has-feedback {{ $errors->has('provinsi') ? 'has-error' : '' }}">
											...
											@if ($errors->has('provinsi'))<span class="invalid-feedback" role="alert"><strong>{{ $errors->first('provinsi') }}</strong></span> @endif
										</div>
										...
										<div class="form-group has-feedback {{ $errors->has('kabupaten') ? 'has-error' : '' }}">
											...
											@if ($errors->has('kabupaten'))<span class="invalid-feedback" role="alert"><strong>{{ $errors->first('kabupaten') }}</strong></span> @endif
										</div>
										...
										<div class="form-group has-feedback {{ $errors->has('kecamatan') ? 'has-error' : '' }}">
											...
											<select class="form-control" name="kecamatan" required>
												...
												<option value='Rembangan'"> Rembangan </option>
											...
											@if ($errors->has('kecamatan'))<span class="invalid-feedback" role="alert"><strong>{{ $errors->first('kecamatan') }}</strong></span> @endif
										</div>

										<div class="form-group has-feedback {{ $errors->has('kelurahan') ? 'has-error' : '' }}">
											<label for="kelurahan" class="col-form-label">{{ __('Kelurahan') }}</label>
											<input name="kelurahan" value="{{ old('kelurahan') }}" type="text" class="form-control" placeholder="Kelurahan" required>											
											@if ($errors->has('kelurahan'))<span class="invalid-feedback" role="alert"><strong>{{ $errors->first('kelurahan') }}</strong></span> @endif
										</div>

										<div class="form-group has-feedback {{ $errors->has('foto_kandang') ? 'has-error' : '' }}">
											<label for="foto_kandang" class="col-form-label">{{ __('Foto Kandang') }}</label>
											<input name="foto_kandang" value="{{ old('foto_kandang') }}" type="file" class="form-control" placeholder="Foto Kandang"required> 
											@if ($errors->has('foto_kandang'))<span class="invalid-feedback" role="alert"><strong>{{ $errors->first('foto_kandang') }}</strong></span> @endif
										</div>

										<div class="form-group has-feedback {{ $errors->has('foto_ktp') ? 'has-error' : '' }}">
											<label for="foto_ktp" class="col-form-label">{{ __('Foto KTP') }}</label>
										...
										<div class="form-group has-feedback {{ $errors->has('foto_profil') ? 'has-error' : '' }}">
											<label for="foto_profil" class="col-form-label">{{ __('Foto Profil') }}</label>
										...
										{{-- <div class="form-group has-feedback {{ $errors->has('no_ktp') ? 'has-error' : '' }}">
											<label for="no_ktp" class="col-form-label">{{ __('No KTP') }}</label>
											<input name="no_ktp" value="{{ old('no_ktp') }}" type="text" class="form-control" placeholder="No KTP" required>											@if($errors->has('no_ktp')) <span class="help-block">{{ $errors->first('no_ktp') }}</span> @endif
										</div> --}}

										<div class="form-group has-feedback {{ $errors->has('no_telp') ? 'has-error' : '' }}">
											<label for="no_telp" class="col-form-label">{{ __('No telphone') }}</label>
											<input name="no_telp" value="{{ old('no_telp') }}" type="text" class="form-control" placeholder="No Telp" required>											@if($errors->has('no_telp')) <span class="help-block">{{ $errors->first('no_telp') }}</span> @endif
										</div>

										<div class="form-group has-feedback {{ $errors->has('tgl_lahir') ? 'has-error' : '' }}">
											<label for="tgl_lahir" class="col-form-label">{{ __('Tanggal Lahir') }}</label>
											<input name="tgl_lahir" value="{{ old('tgl_lahir') }}" type="date" class="form-control" required>
