                    ...
                    <div class="container-fluid">
                      <form>
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="recipient-name" value="{{ old('nama') ? old('nama') : Auth::user()->nama}}" placeholder="Nama">
                        </div>
                        <div class="form-group">
                          <label for="jenis_kelamin" class="col-form-label">Jenis Kelamin :</label>
                          <input type="text" class="form-control" id="recipient-name" value="{{ old('jenis_kelamin') ? old('jenis_kelamin') : $investor->jenis_kelamin}}">
                        </div>
                        <div class="form-group">
                          <label for="no_telp" class="col-form-label">Nomor Telephone :</label>
                          <input type="text" class="form-control" id="recipient-name" value="{{ old('no_telp') ? old('no_telp') :$investor->no_telp}}">
                        </div>
                      </form>
                    </div>
                  </div>
                    ...
                    <div class="container-fluid">
                      <form action="/peternak/{{Auth::user()->id}}/edit" method="post">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" name="nama" class="form-control" id="mod-inputan" value="{{ old('nama') ? old('nama') : Auth::user()->nama}}" placeholder="Nama">
                        </div>
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="jenis_kelamin" value="{{ old('jenis_kelamin') ? old('jenis_kelamin') : $peternak->jenis_kelamin}}">
                        </div>
